...
const Contact = () => {
  return (
    <div>
      ...
      {/* hero */}
      <div
        className="flex flex-col items-center justify-center h-[58vh] bg-[#1A365D]"
      >
        
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif text-white mb-6">Contact Azure Horizon</h1>
