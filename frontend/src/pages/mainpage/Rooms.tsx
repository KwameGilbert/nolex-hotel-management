...
const Rooms = () => {
  return (
    <div>
      ...
      {/* hero section */}
      <div
        className="flex flex-col items-center justify-center h-[75vh] md:h-[56vh]"
  ...
  `,
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold text-white text-center">Luxury Accommodations</h1>
